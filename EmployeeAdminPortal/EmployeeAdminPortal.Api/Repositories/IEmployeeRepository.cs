...
namespace EmployeeAdminPortal.Api.Repositories
{
    ...
    {
        Task<List<Employee>> GetAllEmployeesAsync(string? filterOn=null, string? filterQuery=null,string? sortBy=null, bool isAscending=true,int pageNumber=1,int pageSize=10);
